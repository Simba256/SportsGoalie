...
export const questionTypeSchema = z.enum(['multiple_choice', 'true_false', 'descriptive', 'image_choice'], {
  errorMap: () => ({ message: 'Question type must be multiple_choice, true_false, descriptive, or image_choice' }),
});
